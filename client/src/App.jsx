...
function App() {
  ...
  useEffect(() => {
    if (isConnected && account) {
      setShowWelcome(true);
      toast.success(`Welcome to GrievanceIQ! Connected to ${account.slice(0, 6)}...${account.slice(-4)}`, {
        icon: '🎉'
      });
  ...
  if (isConnecting || !isInitialized) {
    const loadingMessage = isConnecting 
      ...
      : 'GrievanceIQ शुरू हो रहा है... • Initializing GrievanceIQ...';
          ...
          <Grid container spacing={4} alignItems="center">
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="body2" sx={{ color: '#7B3F00', fontWeight: 500 }}>
                © {currentYear} GrievanceIQ. सभी अधिकार सुरक्षित • All rights reserved.
              </Typography>
            </Grid>
